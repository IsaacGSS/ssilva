export default function Home() {
  return (
    <main className='h-screen flex flex-col text-white justify-center items-center gap-5'>
      ...
      <h2 className='text-sm font-light font-lato text-white/95 tracking-widest lg:w-1/2 md:w-[80%] w-full px-5 text-wrap text-center'>
        sou {''}
        <b className='font-semibold text-white/80'>Desenvolvedor Web</b>. Crio e
        desenvolvo solucoes com criatividade para suas paginas web e outras
